...
$(document).ready(function() { 
    ...
    $.ajax({
        url: "https://api.themoviedb.org/3/movie/" + window.localStorage.getItem('movieId') + "?api_key=2e1df8ace23920f40d96768a07c873b1&language=pt-BR&append_to_response=videos,images,credits,reviews",
        type: "GET",
